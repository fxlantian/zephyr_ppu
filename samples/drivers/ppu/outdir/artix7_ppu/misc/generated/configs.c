...
GEN_ABSOLUTE_SYM(CONFIG_SPI_0_IRQ_PRI, 1);
...
GEN_ABSOLUTE_SYM(CONFIG_SPI_PPU, 1);
...
GEN_ABSOLUTE_SYM(CONFIG_PINMUX_PPU_0_NAME, 1);
GEN_ABSOLUTE_SYM(CONFIG_PINMUX_PPU, 1);
...
GEN_ABSOLUTE_SYM(CONFIG_I2C_PPU, 1);
